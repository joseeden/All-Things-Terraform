...
#--------------------------------------------------------------
# This terraform template deploys a VPC with 2 public subnets that has a 
# security group, an internet gateway, a NAT gateway, and an Application loadbalancer.
# Traffic will be loadbalanced between the EC2 instances in the autoscaling group.
# Finally, the instances are bootstrapped with an NGINX webserver.
#--------------------------------------------------------------
...
# allows outbound traffic to go through only the webserber security gtoup
